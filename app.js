...
//"this" is the scope of the joe, the object we defined on line 171 with values Joe, Schmoe, and 100.

// 2. What is "this" when joe.scopeArrow() is invoked?
//Since arrow functions can't be used as constructors or methods, 'this' in reference to scopeArrow returns a window instead of the values of the object joe. 

// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions don't have their own 'this', so a 'this' used in arrow functions will be established based on the scope the arrow function is defined within (so, determined by its parent's scope).
